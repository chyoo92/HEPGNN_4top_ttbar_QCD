...
#parser.add_argument('-w','--weight', action='store_false', default=True, help='flag to not store weights in pt image')
...
for i in range(len(res)):
    ...
    file_name = res[i]
    print(file_name,'eeeeeeeeeeeeeeeeee')     
