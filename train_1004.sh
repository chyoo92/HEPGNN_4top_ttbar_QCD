...
python train_4top_abs_4fea_h5.py --config config_QCD_4top_h5.yaml --epoch 200 --batch 1024 -o 210927_abs_QCD_4top_4fea --device 0 --cla 1 --model GNN1layer --fea 4

python eval_4top_abs_4fea_h5.py --config config_QCD_4top_h5.yaml --batch 1024 -o 210927_abs_QCD_4top_4fea --device 0 --cla 1
